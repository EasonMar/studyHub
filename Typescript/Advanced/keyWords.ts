...
// 特别注意: 枚举类型可能有多个类型...也可能只有一个类型... 就跟遍历数组, 数组的元素可能有多个, 也可能只有一个元素一样
// -------- 看到类似 [P in number]: string 这种情况...要反应过来...
...
/**
 * 泛型推断 infer 【Good】https://segmentfault.com/a/1190000018514540?utm_source=tag-newest
